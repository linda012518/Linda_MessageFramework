...
namespace Framework
{
    ...
    /// 消息管理器
    /// </summary>
    public class MessageManager : BaseManager, IExecuteHandler
    {
        ...
        public void Execute(int eventCode, params object[] message)
        {
        ...
        internal void Add(int eventCode, IExecuteHandler mono)
        {
        ...
        internal void Add(int[] eventCodes, IExecuteHandler mono)
        {
        ...
        internal void Remove(int eventCode, IExecuteHandler mono)
        {
            //没注册过 没法移除 报个警告
            if (!_dict.ContainsKey(eventCode))
            {
        ...
        internal void Remove(int[] eventCodes, IExecuteHandler mono)
        {
            for (int i = 0; i < eventCodes.Length; i++)
            {
